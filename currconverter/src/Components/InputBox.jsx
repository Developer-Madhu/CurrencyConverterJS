  ...
  return (
    <div className={`${className}`}>
      <div className='w-1/2'>
        ...
        <input id={id} type="number" className='outline-none w-full bg-transparent py-1.5' placeholder='Amount' disabled={disableAmt} value={amount} onChange={(e) => onAmountChange && onAmountChange(Number(e.target.value))} />
      </div>
